...
interface IRational {
	...
	default IRational add(IRational that) throws IllegalArgumentException {
		...
		n1 = getNumerator() * that.getDenominator() + that.getNumerator() * getDenominator();
		d1 = getDenominator() * that.getDenominator();
		return construct(n1, d1);
	...
	default IRational mul(IRational that) throws IllegalArgumentException {
		...
		n1 = getNumerator() * that.getNumerator();
		d1 = getDenominator() * that.getDenominator();
		return construct(n1, d1);
	}
	...
	default IRational div(IRational that) throws IllegalArgumentException {
		...
		n1 = getNumerator() * that.getDenominator();
		d1 = getDenominator() * that.getNumerator();
		return construct(n1, d1);
	}
}
