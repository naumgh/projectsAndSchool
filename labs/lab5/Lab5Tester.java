...
public class Lab5Tester {
    ...
    public static void testDoubleAtOddElements(){
        ...
        emptyList.doubleAtOddElements();

        displayResults(emptyList.toString().equals(""), "testDoubleAtOddPositions - empty");
        

        list3a.doubleAtOddElements();
        System.out.println(list3a.toString());
        displayResults(list3a.toString().equals("8, 4, 6, -2"), "testDoubleAtOddPositions - length3");
