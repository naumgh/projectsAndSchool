...
public class Lab4Tester {
    ...
    public static void testList() {
        ...
        Student s00  = new Student("abc", 50);
        Student s01  = new Student("def", 56);
        Student s02  = new Student("xyz", 99);
        Student s02b  = new Student("xyz", 29);
    
       /*
        Student[] student_empty = {};
        Student[] initial_list = {s01, s02, s02b};
        Student[] add_back = {s00, s01, s02, s02b};
        */

        StudentLinkedList q = new StudentLinkedList();
       // a = q.toString(a);

        q.add(s00);

        String resultString = q.toString();
        String expectedString = s00.toString();
        System.out.println("result:" + resultString);
        System.out.println("expected:" + expectedString);
        displayResults(resultString.equals(expectedString), "test add with toString");

        displayResults(q.size() == 1, "size is 1");

        q.add(s02b);

        displayResults(q.size() == 2, "size is 2");
